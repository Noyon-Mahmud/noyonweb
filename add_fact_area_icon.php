...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <a class="breadcrumb-item" href="index.html">add fact-area</a>
            ...
            <div class="row">
                <div class="col-lg-12 m-auto">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <div class="icon p-2"
                                style="background: #f5f5f5; height:200px; overflow:scroll; cursor:pointer; font-size:40px">
                                <?php foreach($fonts as $icon){?>
                                <i class=" m-2 fa social_icon <?=$icon?>" name="<?=$icon?>"></i>
                                <?php }?>
                            </div>
                            ...
                            <form action="fact_area_post.php" method="POST">
                                <div class="mt-3 pos-lg-relative">
                                    ...
                                    <input type="text" name="icon_class" id="icon_input" class="form-control" style="color: transparent;">
                                    <i style="position: absolute;top: 36px;left:18px;font-size: 28px;" class="fa " id="icon2"></i>
                                </div>
                                <div class="mt-3">
