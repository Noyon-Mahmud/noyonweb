                    ...
                    <div class="col-xl-9 col-lg-10">
                        <div class="single-blog-list">
                            <div class="blog-list-thumb mb-35">
                                <img src="uploads/protfolio/<?=$after_assoc['image']?>" alt="img">
                            </div>
                                ...
                                <div class="blog-list-meta">
                                    <ul>
                                        ...
                                        <li class="blog-post-share">
                                            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?app_id=http://127.1.0.0/time_nai/portfolio-single.php?id=<?=$id?>"><i class="fab fa-facebook-f"></i></a>
                                ...
                                <ul>
                                    <li>
                                        <div class="post-avatar-img">
                                            <img width="100" height="100" src="uploads/user/<?=$after_assoc['profile_photo']?>" alt="img">
                                        </div>
                                        <div class="post-avatar-content">
                                            <h5><?=$after_assoc['name']?></h5>
